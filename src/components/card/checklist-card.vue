<template>
  <div>
    ...
    <div class="item-wrap item-title" v-if="id[0] === 'Title'" :id="[`hash${index}`]">
      ...
      <div class="drag-bar bg-success js-drag-bar drag-bar-full-height"><i class="fa fa-arrows-v" aria-hidden="true"></i></div>
    </div> 
    <div class="item-wrap" v-else :id="[`hash${index}`]">
      ...
      <div class="drag-bar bg-success js-drag-bar"><i class="fa fa-arrows-v" aria-hidden="true"></i></div>
    </div>
    ...
    methods: {
      ...
      toggleFinished: function() {
        ...
        const date = `
          ...
          ${finishedDate.getHours() < 10 ? '0' + finishedDate.getHours() : finishedDate.getHours()}:${finishedDate.getMinutes()}
        `

        let value = this.item.finish.isFinished ? false : true;
